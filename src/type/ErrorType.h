#ifndef SRC_TYPE_ERRORTYPE_H_
#define SRC_TYPE_ERRORTYPE_H_

#include "Type.h"

namespace type {

class ErrorType: public Type, public enable_shared_from_this<ErrorType> {
public:
	ErrorType();
	virtual ~ErrorType();
